...
const httpLinkAvax = createHttpLink({
  uri: "https://api.studio.thegraph.com/query/60251/zeta-project-avalanche/v0.0.2", // reemplaza por tu endpoint de GraphQL
});
const httpLinkSepolia = createHttpLink({
  uri: "https://api.studio.thegraph.com/query/60251/zeta-project-sepolia_receiver/v0.0.2", // reemplaza por tu endpoint de GraphQL
});
